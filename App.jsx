      ...
      <div style={{
        ...
        <div style={{ padding: "16px 20px", borderBottom: `1px solid ${C.border}`, display: "flex", justifyContent: "space-between", alignItems: "start", flexShrink: 0 }}>
          ...
          <button onClick={onClose} style={{
            background: "transparent", border: "none", color: C.textMuted, fontSize: 20, cursor: "pointer", padding: "0 4px",
          }}>×</button>
        </div>
...
export default function PromptEvalTool() {
...
json{
  ...
  const exportCSV = useCallback(() => {
    ...
    const rows = results.evaluated.map(r => [
      r.index + 1, r.groundTruth, r.p1Predicted || "ERROR", r.p1Reasoning || "", r.p2Predicted || "ERROR", r.p2Reasoning || "",
